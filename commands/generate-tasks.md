...
1. **Receive Requirements:** Analyze the feature request, task description, or documentation provided by the user: $ARGUMENTS
...
Example:
- `- [ ] 1.1 Create component` → `- [x] 1.1 Create component`
