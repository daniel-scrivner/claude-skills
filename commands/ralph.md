...
**Requires**: Claude Code CLI (`claude --dangerously-skip-permissions`)

## Quick Start

1. **Scaffold**: `/ralph scaffold` to create `scripts/ralph/` in your project
2. **Configure**: Edit `scripts/ralph/prd.json` with your tasks
3. **Run**: `./scripts/ralph/ralph.sh 25` (runs up to 25 iterations)

---

## When Invoked with "scaffold": Create These Files
...
- **Reference /pr-workflow** - For PR finalization, follow the /pr-workflow command
````
